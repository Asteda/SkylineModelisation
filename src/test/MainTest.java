...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		Service s1 = new Service(1, "s1", tags1, lod1, qos1);
		Service s2 = new Service(2, "s2", tags2, lod2, qos2);
		Service s3 = new Service(3, "s3", tags3, lod3, qos3);
		Service s4 = new Service(4, "s4", tags4, lod4, qos4);
		Service s5 = new Service(5, "s5", tags5, lod5, qos5);
		Service s6 = new Service(6, "s6", tags6, lod6, qos6);
		

		//System.out.println(m1.toString());
		
		Mashup m2 = Mashup.generateMashup(5);
